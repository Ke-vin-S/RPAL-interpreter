package io.github.ke_vin_s.rpal.cli;

import io.github.ke_vin_s.rpal.core.compiler.RPALCompiler;
import io.github.ke_vin_s.rpal.core.compiler.RPALInterpreter;
import io.github.ke_vin_s.rpal.core.cse_machine.CseMachine;
import io.github.ke_vin_s.rpal.core.cse_machine.io.ConsoleOutputWriter;
...
public class Main {
    public static void main(String[] args) {
        ...
        RPALInterpreter interpreter = new RPALInterpreter(
                compiler.getControlStructures(),
    ...
    private static CLIArguments parseArguments(String[] args) {
        try {
            ...
            System.out.println("Usage: rpal <filename> [-ast] [-st] [-control] [-cse]");
